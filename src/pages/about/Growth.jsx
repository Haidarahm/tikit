  ...
  return (
    ...
    >
      <div className="left-section md:w-2/3 ">
        ...
        <p
          className="description text-[16px] sm:text-[20px] md:text-[32px] font-light loco-growth-text mt-3 md:mt-4"
          data-scroll
          data-scroll-class="is-inview"
          data-scroll-repeat
        >
      ...
      <div className="right-section md:w-1/3 flex-1 relative min-h-[280px] md:min-h-0">
        <div
          key={data[0].id}
          className="flex items-center md:right-1/2 md:top-0 top-0 left-0 md:left-auto justify-center text-center flex-col w-[150px] h-[150px] md:w-[170px] md:h-[170px] rounded-full absolute bg-[#ffffff29] loco-growth-circle"
          data-scroll
          data-scroll-class="is-inview"
          data-scroll-repeat
        >
