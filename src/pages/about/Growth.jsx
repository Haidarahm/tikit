  ...
  return (
    ...
    >
      <div className="left-section w-2/3 ">
        <h1 className="title text-[36px] capitalize">
          We craft smart, scalable strategies that <br/> spark real growth
        </h1>
        <p className="description text-[32px] font-light">
      ...
      <div className="right-section w-1/3 flex-1 relative">
        <div
          key={data[0].id}
          className="flex items-center right-1/2 justify-center text-center flex-col w-[170px] h-[170px] rounded-full absolute bg-[#ffffff29] "
        >
        ...
        <div
          key={data[1].id}
          className="flex px-4  bottom-0 left-1/2 items-center justify-center text-center flex-col w-[170px] h-[170px] rounded-full absolute bg-[#ffffff29] "
        >
