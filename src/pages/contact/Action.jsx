  ...
  return (
    <div data-scroll-section className="snap-start snap-always gap-[120px] h-screen flex py-20 px-14">
      ...
      <div className="right-section w-1/2 h-full flex flex-col gap-[40px]">
          ...
          <div className="inputs grid-rows-4 gap-[30px] grid grid-cols-2 flex-1">
            <FloatingInput
              id="contact-standard"
              label="Name"
...
<button
class="px-5 py-2.5 relative col-span-2 row-span-1 rounded-full group overflow-hidden font-medium bg-transparent text-white border border-white flex items-center justify-center">
<span
