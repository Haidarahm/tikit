...
export const ScrollStackItem = ({ children, itemClassName = "" }) => (
  <div
    className={`scroll-stack-card md:h-[395px] gap-[12px] md:gap-0 relative   my-8 p-2 md:p-[30px] xl:p-[50px] rounded-[5px] md:rounded-[40px] shadow-[0_0_30px_rgba(0,0,0,0.1)] box-border origin-top will-change-transform ${itemClassName}`.trim()}
    style={{
...
const ScrollStack = ({
  ...
  return (
    ...
    >
      <div className="scroll-stack-inner pt-[5vh] md:px-20 min-h-screen">
        {children}
