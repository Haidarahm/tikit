...
function TikitButton({ text }) {
  return (
    <button className="group inline-flex items-center gap-2 font-hero-light text-sm bg-primary text-background px-4 py-2 rounded-full transition-colors focus:outline-none">
